...
int ms = wiringPiI2CSetup(press_address);

float MS4525Getpressure()
{
	return(wiringPiI2CReadReg16(ms,0));
}
...
void loop() // Main loop
{
	 float temperature = 25;//bmp085GetTemperature(bmp085ReadUT()); //MUST be called first
